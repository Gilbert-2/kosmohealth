<template>
  <div class="flo-face-processing-wrapper" v-if="shouldShowFaceProcessing">
    <flo-design-face-processing
      v-if="videoElement"
...
<script>
import FloDesignFaceProcessing from './FloDesignFaceProcessing.vue';
import FaceProcessingVisibilityService from '../services/FaceProcessingVisibilityService';

export default {
  name: 'FloDesignFaceProcessingWrapper',
  components: {
